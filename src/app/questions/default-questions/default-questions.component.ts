...
export class DefaultQuestionsComponent implements OnInit {
  ...
  constructor(public defaultQuestionsService: DefaultQuestionsService, public authService: AuthService, public questionsService: QuestionsService) { }
  ...
  ngOnInit() {
    ...
    this.defaultQuestionsSub = this.defaultQuestionsService.getQuestionsUpdatedListener().subscribe((questionsData: { questions: Question[]}) => {
      this.questions = questionsData.questions;

      if (this.userId) {
        this.questionsService.getQuestions(this.userId);
        this.userQuestionsSub = this.questionsService.getQuestionsUpdatedListener().subscribe((userQuestionsData: { questions: Question[]}) => {
